...
export const Route = createFileRoute("/categories")({
  head: () => ({ meta: [{ title: "Categories — ShopSphere" }, { name: "description", content: "Browse all categories." }] }),
...
function CategoriesPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
      ...
      <p className="mt-3 max-w-xl text-muted-foreground">Six curated worlds. Pick one to start exploring.</p>
